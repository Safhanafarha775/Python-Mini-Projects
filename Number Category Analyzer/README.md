...
Whole number? → Then Odd/Even
Numerical sign → Positive/Negative/Zero
Divisibility → 5, 10
Range → 1 to 100
...
➡️ The number is Odd.
➡️ The number is Positive.
➡️ The number is divisible by 5.
➡️ Not divisible by 10.
...
How to check conditions using operators
How to work with floating vs. integer values
